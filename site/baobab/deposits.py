...
def get_form_pids_config():
    ...
    for scheme in service.config.pids_providers.keys():
        ...
        pids_provider = {
            ...
            "field_label": "testing",
            "pid_label": "ARK",
            "pid_placeholder": "Copy/paste your existing ARK here...",
            ...
            "btn_label_get_pid": _("Get an {scheme_label} now!").format(
                scheme_label=scheme_label
            ),
            "managed_help_text": _(
                "Reserve an {scheme_label} by pressing the button "
            ...
            "unmanaged_help_text": _(
                "An {scheme_label} allows your upload to be easily and "
                "unambiguously cited. Example: ark:/50962/bb67854"
            ).format(scheme_label=scheme_label),
        }
...
def new_record():
    ...
    if "ark" in current_rdm_records.records_service.config.pids_providers:
        record["pids"] = {"ark": {"provider": "pidslink", "identifier": ""}}
    else:
        record["pids"] = {}
    record["status"] = "draft"
